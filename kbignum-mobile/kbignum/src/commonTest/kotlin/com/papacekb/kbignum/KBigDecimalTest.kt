...
class KBigDecimalTest {
	...
	@Test fun `test add with mc`() {
		...
		assertEquals(KBigDecimal("-4.01E+8"), KBigDecimal("759876622.173756").add(KBigDecimal("-1161332847.470284"), KMathContext(3, CEILING)))
		assertEquals(KBigDecimal("1.0627531E+9"), KBigDecimal("924565987.3278322").add(KBigDecimal("138187048.76235235"), KMathContext(8, UP)))
		assertEquals(KBigDecimal("-9.9400E+8"), KBigDecimal("-1406996614.7088475").add(KBigDecimal("412990833.2978394"), KMathContext(5, DOWN)))
		...
		assertEquals(KBigDecimal("-9.9467E+8"), KBigDecimal("-522341963.14925516").add(KBigDecimal("-472325589.02161324"), KMathContext(5, HALF_EVEN)))
	}
	...
	@Test fun `test divide with rounding mode`() {
		...
		assertEquals(KBigDecimal("6.32869146"), KBigDecimal("-114075683.93385269").divide(KBigDecimal("-18025161.200536225"), FLOOR))
		assertEquals(KBigDecimal("22.6244499"), KBigDecimal("909140873.6147215").divide(KBigDecimal("40183999.0187007"), FLOOR))
		assertEquals(KBigDecimal("1.7820176"), KBigDecimal("1298872479.0962298").divide(KBigDecimal("728877430.1486664"), FLOOR))
		assertEquals(KBigDecimal("-0.33476561"), KBigDecimal("18147998.73683848").divide(KBigDecimal("-54211060.0672527"), CEILING))
		...
		assertEquals(KBigDecimal("-1.4676572"), KBigDecimal("-292353598.6409018").divide(KBigDecimal("199197463.1572587"), HALF_EVEN))
	...
	@Test fun `test divide with math context`() {
		assertEquals(KBigDecimal("-0.161586"), KBigDecimal("67292179.71385333").divide(KBigDecimal("-416447777.4133185"), KMathContext(6, CEILING)))
		assertEquals(KBigDecimal("-0.677716"), KBigDecimal("-785212155.7348468").divide(KBigDecimal("1158616935.3838212"), KMathContext(6, UP)))
		assertEquals(KBigDecimal("-1.1145"), KBigDecimal("-1160812480.4163346").divide(KBigDecimal("1041558883.1254534"), KMathContext(5, UP)))
		assertEquals(KBigDecimal("0.091637"), KBigDecimal("-28852079.859152712").divide(KBigDecimal("-314848860.1390203"), KMathContext(5, DOWN)))
		...
		assertEquals(KBigDecimal("0.511"), KBigDecimal("152796620.5265021").divide(KBigDecimal("299086193.5363742"), KMathContext(3, HALF_DOWN)))
		...
		assertEquals(KBigDecimal("0.60428"), KBigDecimal("321943312.85114264").divide(KBigDecimal("532764659.1024282"), KMathContext(5, FLOOR)))
		assertEquals(KBigDecimal("-2.4"), KBigDecimal("1598230603.4288957").divide(KBigDecimal("-640537007.7833391"), KMathContext(2, DOWN)))
		assertEquals(KBigDecimal("-0.66367"), KBigDecimal("28655590.948701665").divide(KBigDecimal("-43176888.62237175"), KMathContext(5, DOWN)))
		assertEquals(KBigDecimal("0.57"), KBigDecimal("-740028390.0913398").divide(KBigDecimal("-1298525333.7510824"), KMathContext(2, HALF_EVEN)))
	}
	...
	@Test fun `test divideAndRemainder with math context`() {
		assertEquals(listOf(KBigDecimal("0.0"), KBigDecimal("42717969.40366649")), KBigDecimal("42717969.40366649").divideAndRemainder(KBigDecimal("-1590727659.9535892"), KMathContext(3, HALF_UP)).asList())
		...
		assertEquals(listOf(KBigDecimal("0.00"), KBigDecimal("25553502.832766782")), KBigDecimal("25553502.832766782").divideAndRemainder(KBigDecimal("648425442.8635095"), KMathContext(1, HALF_EVEN)).asList())
		...
		assertEquals(listOf(KBigDecimal("-4"), KBigDecimal("-204400783.88747332")), KBigDecimal("-1498939511.9978392").divideAndRemainder(KBigDecimal("323634682.02759147"), KMathContext(5, CEILING)).asList())
