...
class KBigDecimalTest {
	...
	@Test fun `test add with mc`() {
		assertEquals(KBigDecimal("-1.150268E+9"), KBigDecimal("-675844085.4233485").add(KBigDecimal("-474423814.94483757"), KMathContext(7, HALF_EVEN)))
	...
	@Test fun `test divide with rounding mode`() {
		assertEquals(KBigDecimal("6.767746"), KBigDecimal("1480823056.843158").divide(KBigDecimal("218805968.26770258"), UP))
		assertEquals(KBigDecimal("6.32869147"), KBigDecimal("-114075683.93385269").divide(KBigDecimal("-18025161.200536225"), UP))
		assertEquals(KBigDecimal("22.6244499"), KBigDecimal("909140873.6147215").divide(KBigDecimal("40183999.0187007"), DOWN))
		assertEquals(KBigDecimal("1.7820177"), KBigDecimal("1298872479.0962298").divide(KBigDecimal("728877430.1486664"), CEILING))
		assertEquals(KBigDecimal("-0.33476561"), KBigDecimal("18147998.73683848").divide(KBigDecimal("-54211060.0672527"), HALF_EVEN))
		assertEquals(KBigDecimal("0.46328125"), KBigDecimal("-254964721.59129804").divide(KBigDecimal("-550345435.2300467"), FLOOR))
		assertEquals(KBigDecimal("1.06437207"), KBigDecimal("-294148612.06468046").divide(KBigDecimal("-276358823.690559"), HALF_DOWN))
		assertEquals(KBigDecimal("-1.4676572"), KBigDecimal("-292353598.6409018").divide(KBigDecimal("199197463.1572587"), HALF_UP))
		assertEquals(KBigDecimal("-5.1666804"), KBigDecimal("778374847.6050745").divide(KBigDecimal("-150652795.90001202"), HALF_UP))
	...
	@Test fun `test divide with math context`() {
		...
		assertEquals(KBigDecimal("-1.1144"), KBigDecimal("-1160812480.4163346").divide(KBigDecimal("1041558883.1254534"), KMathContext(5, DOWN)))
		...
		assertEquals(KBigDecimal("-0.0967808861"), KBigDecimal("-33341244.8754943").divide(KBigDecimal("344502372.5551315"), KMathContext(9, FLOOR)))
		...
		assertEquals(KBigDecimal("-2.5"), KBigDecimal("1598230603.4288957").divide(KBigDecimal("-640537007.7833391"), KMathContext(2, HALF_EVEN)))
	...
	@Test fun `test divideAndRemainder with math context`() {
		...
		assertEquals(listOf(KBigDecimal("0.0"), KBigDecimal("-324530096.98066115")), KBigDecimal("-324530096.98066115").divideAndRemainder(KBigDecimal("447661384.4024426"), KMathContext(5, HALF_DOWN)).asList())
		assertEquals(listOf(KBigDecimal("0.00"), KBigDecimal("25553502.832766782")), KBigDecimal("25553502.832766782").divideAndRemainder(KBigDecimal("648425442.8635095"), KMathContext(1, UP)).asList())
		...
		assertEquals(listOf(KBigDecimal("0.0"), KBigDecimal("212299470.94247726")), KBigDecimal("212299470.94247726").divideAndRemainder(KBigDecimal("1018749155.5705159"), KMathContext(7, HALF_DOWN)).asList())
		assertEquals(listOf(KBigDecimal("0"), KBigDecimal("185739914.30591717")), KBigDecimal("185739914.30591717").divideAndRemainder(KBigDecimal("454240870.06959987"), KMathContext(4, UP)).asList())
		...
		assertEquals(listOf(KBigDecimal("-7"), KBigDecimal("154209408.17746801")), KBigDecimal("1464574829.3096583").divideAndRemainder(KBigDecimal("-187195060.16174147"), KMathContext(7, HALF_DOWN)).asList())
		assertEquals(listOf(KBigDecimal("0.0"), KBigDecimal("-120187432.93513387")), KBigDecimal("-120187432.93513387").divideAndRemainder(KBigDecimal("1672685224.8150556"), KMathContext(8, FLOOR)).asList())
