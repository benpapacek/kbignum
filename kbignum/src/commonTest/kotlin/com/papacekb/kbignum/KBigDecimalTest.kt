...
class KBigDecimalTest {
	...
	@Test fun `test add with mc`() {
		assertEquals(KBigDecimal("-1.150267E+9"), KBigDecimal("-675844085.4233485").add(KBigDecimal("-474423814.94483757"), KMathContext(7, DOWN)))
		...
		assertEquals(KBigDecimal("9.9613069E+8"), KBigDecimal("-379804388.84803605").add(KBigDecimal("1375935074.0174305"), KMathContext(8, HALF_EVEN)))
		assertEquals(KBigDecimal("3E+8"), KBigDecimal("199199851.7758977").add(KBigDecimal("157505219.99844605"), KMathContext(1, FLOOR)))
		assertEquals(KBigDecimal("-7.7595185E+8"), KBigDecimal("-1128584244.777766").add(KBigDecimal("352632385.3791467"), KMathContext(8, CEILING)))
		assertEquals(KBigDecimal("1.1463995E+9"), KBigDecimal("354109522.14027476").add(KBigDecimal("792289997.9249882"), KMathContext(8, DOWN)))
	...
	@Test fun `test divide with rounding mode`() {
		assertEquals(KBigDecimal("6.767745"), KBigDecimal("1480823056.843158").divide(KBigDecimal("218805968.26770258"), FLOOR))
		assertEquals(KBigDecimal("6.32869147"), KBigDecimal("-114075683.93385269").divide(KBigDecimal("-18025161.200536225"), HALF_EVEN))
		assertEquals(KBigDecimal("22.6244499"), KBigDecimal("909140873.6147215").divide(KBigDecimal("40183999.0187007"), HALF_UP))
		...
		assertEquals(KBigDecimal("0.46328126"), KBigDecimal("-254964721.59129804").divide(KBigDecimal("-550345435.2300467"), UP))
		assertEquals(KBigDecimal("1.06437207"), KBigDecimal("-294148612.06468046").divide(KBigDecimal("-276358823.690559"), CEILING))
		assertEquals(KBigDecimal("-1.4676573"), KBigDecimal("-292353598.6409018").divide(KBigDecimal("199197463.1572587"), UP))
		assertEquals(KBigDecimal("-5.1666804"), KBigDecimal("778374847.6050745").divide(KBigDecimal("-150652795.90001202"), HALF_EVEN))
		assertEquals(KBigDecimal("-0.3961429"), KBigDecimal("-571228995.7521011").divide(KBigDecimal("1441976860.8424008"), DOWN))
		assertEquals(KBigDecimal("-3.1837350"), KBigDecimal("-235813042.5722397").divide(KBigDecimal("74068051.56425187"), UP))
	}
	...
	@Test fun `test divide with math context`() {
		...
		assertEquals(KBigDecimal("0.091638"), KBigDecimal("-28852079.859152712").divide(KBigDecimal("-314848860.1390203"), KMathContext(5, HALF_UP)))
		assertEquals(KBigDecimal("-0.0967808860"), KBigDecimal("-33341244.8754943").divide(KBigDecimal("344502372.5551315"), KMathContext(9, DOWN)))
		assertEquals(KBigDecimal("0.511"), KBigDecimal("152796620.5265021").divide(KBigDecimal("299086193.5363742"), KMathContext(3, UP)))
		assertEquals(KBigDecimal("0.322690112"), KBigDecimal("251835260.28429908").divide(KBigDecimal("780424471.6630119"), KMathContext(9, HALF_UP)))
		assertEquals(KBigDecimal("0.60429"), KBigDecimal("321943312.85114264").divide(KBigDecimal("532764659.1024282"), KMathContext(5, UP)))
		assertEquals(KBigDecimal("-2.5"), KBigDecimal("1598230603.4288957").divide(KBigDecimal("-640537007.7833391"), KMathContext(2, UP)))
	...
	@Test fun `test divideAndRemainder with math context`() {
		...
		assertEquals(listOf(KBigDecimal("2"), KBigDecimal("-75753770.2429225")), KBigDecimal("-829736041.1504835").divideAndRemainder(KBigDecimal("-376991135.4537805"), KMathContext(2, FLOOR)).asList())
		assertEquals(listOf(KBigDecimal("-4"), KBigDecimal("-204400783.88747332")), KBigDecimal("-1498939511.9978392").divideAndRemainder(KBigDecimal("323634682.02759147"), KMathContext(5, UP)).asList())
		...
		assertEquals(listOf(KBigDecimal("0.0"), KBigDecimal("-120187432.93513387")), KBigDecimal("-120187432.93513387").divideAndRemainder(KBigDecimal("1672685224.8150556"), KMathContext(8, HALF_EVEN)).asList())
...
//		assertEquals(KBigDecimal("-1"), KBigDecimal("249841354.43697646").divideToIntegralValue(KBigDecimal("-182726748.76372012"), KMathContext(5, DOWN)))
//		assertEquals(KBigDecimal("1"), KBigDecimal("890471624.3624302").divideToIntegralValue(KBigDecimal("814179731.8786556"), KMathContext(7, UP)))
//		assertEquals(KBigDecimal("1"), KBigDecimal("-212775941.3541713").divideToIntegralValue(KBigDecimal("-188571704.9722901"), KMathContext(3, HALF_DOWN)))
//		assertEquals(KBigDecimal("0.00"), KBigDecimal("124875163.09732443").divideToIntegralValue(KBigDecimal("-1079043613.873884"), KMathContext(3, CEILING)))
//		assertEquals(KBigDecimal("9"), KBigDecimal("-764171538.7885159").divideToIntegralValue(KBigDecimal("-80169218.02207339"), KMathContext(7, UP)))
//		assertEquals(KBigDecimal("0.0"), KBigDecimal("124773245.69994995").divideToIntegralValue(KBigDecimal("-1194771990.4861174"), KMathContext(8, FLOOR)))
//		assertEquals(KBigDecimal("0E+1"), KBigDecimal("-93602301.2782669").divideToIntegralValue(KBigDecimal("-116901767.36363001"), KMathContext(1, UP)))
...
//		assertEquals(KBigDecimal("1"), KBigDecimal("-47260343.89308903").divideToIntegralValue(KBigDecimal("-25204377.979744814"), KMathContext(8, CEILING)))
//	}
