...
class KBigDecimalTest {
	...
	@Test fun `test add with mc`() {
		...
		assertEquals(KBigDecimal("1.0627531E+9"), KBigDecimal("924565987.3278322").add(KBigDecimal("138187048.76235235"), KMathContext(8, CEILING)))
		assertEquals(KBigDecimal("-9.9400E+8"), KBigDecimal("-1406996614.7088475").add(KBigDecimal("412990833.2978394"), KMathContext(5, CEILING)))
		...
		assertEquals(KBigDecimal("-7.7595185E+8"), KBigDecimal("-1128584244.777766").add(KBigDecimal("352632385.3791467"), KMathContext(8, DOWN)))
		...
		assertEquals(KBigDecimal("-1.2331E+8"), KBigDecimal("-244105627.82623768").add(KBigDecimal("120793866.86782597"), KMathContext(5, HALF_DOWN)))
		assertEquals(KBigDecimal("-9.9466E+8"), KBigDecimal("-522341963.14925516").add(KBigDecimal("-472325589.02161324"), KMathContext(5, CEILING)))
	}
	...
	@Test fun `test divide with rounding mode`() {
		...
		assertEquals(KBigDecimal("22.6244500"), KBigDecimal("909140873.6147215").divide(KBigDecimal("40183999.0187007"), UP))
		assertEquals(KBigDecimal("1.7820176"), KBigDecimal("1298872479.0962298").divide(KBigDecimal("728877430.1486664"), DOWN))
	...
	@Test fun `test divide with math context`() {
		...
		assertEquals(KBigDecimal("0.091637"), KBigDecimal("-28852079.859152712").divide(KBigDecimal("-314848860.1390203"), KMathContext(5, FLOOR)))
		...
		assertEquals(KBigDecimal("0.322690112"), KBigDecimal("251835260.28429908").divide(KBigDecimal("780424471.6630119"), KMathContext(9, HALF_DOWN)))
		assertEquals(KBigDecimal("0.60428"), KBigDecimal("321943312.85114264").divide(KBigDecimal("532764659.1024282"), KMathContext(5, DOWN)))
		assertEquals(KBigDecimal("-2.5"), KBigDecimal("1598230603.4288957").divide(KBigDecimal("-640537007.7833391"), KMathContext(2, FLOOR)))
		assertEquals(KBigDecimal("-0.66368"), KBigDecimal("28655590.948701665").divide(KBigDecimal("-43176888.62237175"), KMathContext(5, HALF_UP)))
	...
	@Test fun `test divideAndRemainder with math context`() {
		...
		assertEquals(listOf(KBigDecimal("0.0"), KBigDecimal("212299470.94247726")), KBigDecimal("212299470.94247726").divideAndRemainder(KBigDecimal("1018749155.5705159"), KMathContext(7, HALF_EVEN)).asList())
		...
		assertEquals(listOf(KBigDecimal("-7"), KBigDecimal("154209408.17746801")), KBigDecimal("1464574829.3096583").divideAndRemainder(KBigDecimal("-187195060.16174147"), KMathContext(7, HALF_EVEN)).asList())
		assertEquals(listOf(KBigDecimal("0.0"), KBigDecimal("-120187432.93513387")), KBigDecimal("-120187432.93513387").divideAndRemainder(KBigDecimal("1672685224.8150556"), KMathContext(8, DOWN)).asList())
